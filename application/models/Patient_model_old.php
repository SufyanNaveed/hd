...
class Patient_model extends CI_Model
{
    ...
    public function search_datatable($where_condition, $hospital_id = null, $store_id= null)
    {
    ...
    public function search_datatable_count($where_condition, $hospital_id = null, $store_id = null)
    {
        // Select the total count of distinct patient IDs
        $this->db->select([
    ...
    public function getMaxId()
{
    ...
    public function searchipd_datatable($where_condition, $hospital_id = null)
    {
    ...
    public function searchipd_datatable_count($hospital_id)
    {
