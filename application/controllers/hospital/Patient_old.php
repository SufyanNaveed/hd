    ...
    public function addpatient()
{
    ...
    public function opd_search()
    {
        ...
        $resultlist   = $this->patient_model->search_datatable($where_condition,$this->hospital_id,$this->store_id);
        $total_result = $this->patient_model->search_datatable_count($where_condition,$this->hospital_id,$this->store_id);
    ...
    public function ipd_search()
    {
        ...
        $resultlist   = $this->patient_model->searchipd_datatable($where_condition,$this->hospital_id);
        $total_result = $this->patient_model->searchipd_datatable_count($this->hospital_id);
        $data         = [];
