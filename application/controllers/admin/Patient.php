...
class patient extends Admin_Controller
{
    ...
    public function addpatient()
    {
        ...
        $this->form_validation->set_rules('mr_no', 'MR#', 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (is_numeric($checkPatient)) {
                $array = array('status' => 'fail', 'error' => $msg = array("patient" => "Patient name already exists!"), 'message' => '', 'patientID' => $checkPatient);
                echo json_encode($array);
                exit;
            }
            ...
            $patient_data = array(
                ...
                'father_name'       => $this->input->post('father_name'), // Added father_name
                'mrno'              => $this->input->post('mr_no'),
                'patient_cnic'      => $cnic,
                'mobileno'          => $this->input->post('mobileno'),
            ...
            $this->common_model->saveLog('patient', 'add', $comments);
    ...
    public function ipd_search()
    {
        ...
        foreach ($resultlist as $result_key => $result_value) {
            ...
            $nestedData[] = $result_value->organisation_name;
    ...
    public function update()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->common_model->saveLog('patient', 'update', $comments);
    ...
    public function checkExistPatient($patient_id, $date)
    {
        $this->db->select('opd_details.id');
