                      ...
                      <div class="col-md-12">
                        ...
                        <div class="form-group  col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <textarea class="form-control" name="prescription_footer_note" rows="5" id="comment"></textarea>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="clinical_info"><?php echo "Clinical Information"; ?></label> 
                                      <!--   <small class="req"> *</small>  -->
                                        <textarea name="clinical_info" rows="5" id="clinical_info" class="form-control" ></textarea>
                                        <span class="text-danger"><?php echo form_error('clinical_info'); ?>
                                        </span>
                                    </div> 
                                </div>
                        <div class="clearfix"></div>
    ...
    $('.edit_setting').on('click', function (e) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('textarea[name="clinical_info"]').text(result.clinical_info);
