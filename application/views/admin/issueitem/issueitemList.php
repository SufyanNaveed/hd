...
if ($item['return_date'] == "0000-00-00") {
        ...
        ?>
                                                ...
                                                <td class="mailbox-name">
                                                    <?php
echo isset($item['patient_unique_id']) && !empty($item['patient_unique_id']) ? $item['patient_name'].'('.$item['patient_unique_id'].')' :$item['name'] . " " . $item['docname'] . " "  . "(" . $item['employee_id'] . ")";
                    ...
                    <form id="form1" action="<?php echo base_url() ?>admin/issueitem/add"   name="itemstockform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-4 col-sm-4">
                            ...
                            <select name="account_type" onchange="getIssueUser(this.value)"  id="input-type-student" class="form-control ac_type">
                                ...
                                <option value="opd"><?php echo $this->lang->line('opd').'-'.'Patient'; ?></option>
                                <option value="ipd"><?php echo 'IPD-Patient'; ?></option>
                                <option value="ot"><?php echo 'OT-Patient'; ?></option>
                                <option value="emg"><?php echo 'Emg-Patient'; ?></option>
                                <?php
            ...
            success: function (data) {
                ...
                $.each(data.result, function (i, obj)
                {
                    if (data.usertype == "admin") {
                        ...
                        if(obj.patient_unique_id){
                            name=name+"("+obj.patient_unique_id+")";
                        }
                    }
