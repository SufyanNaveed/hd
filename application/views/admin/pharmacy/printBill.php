        ...
        <div class="col-md-12">
            <div class="">
                ...
                <table width="100%" class="printablea4">
                    <tr>
                        <td align="text-left">
                            <h5><?php echo $this->lang->line('bill') . " #"; ?><?php echo $result["purchase_no"] ?></h5>
                        </td>
                        <td align="right">
                ...
                <hr style="height: 1px; clear: both;margin-bottom: 10px; margin-top: 10px">
                <table class="custom-tableprintablea4" id="testreport" width="100%" border="0">
                    <tr>
                    ...
                    ?>
                        <tr>
                            ...
                            <td align="center"><?php echo number_format($bill["sale_price"], 2); ?></td>
                ...
                <table align="" class="printablea4" style="width: 40%; float: right;">
                    <?php if (!empty($result["total"])) { ?>
                        <tr>
                            ...
                            <!-- <th style="width: 80%;"><?php //echo $this->lang->line('total') . " (" . $currency_symbol . ")"; 
                                                            ?></th> -->
                            <th style="width: 80%;">
                                <h4><b><?php echo $this->lang->line('total') ?></b></h4></b>
                            <td align="right">
                                <h4><b><?php echo $result["total"]; ?></b></h4>
                            </td>
                        </tr>
                    <?php } ?>
