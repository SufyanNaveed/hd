...
<?php } ?>
                ...
                <div class="col-md-12" style="clear: both;">
                    <div class="table-responsive">
                        <table class="custom-table table table table tableover table-striped table-bordered table-hover tablefull12" id="edittableID">
                            <tr >
                            ...
                            foreach ($detail as $key => $value) {
                                ...
                                <tr id="row<?php echo $i ?>">
									...
									<td class="text-right">
                                        <input type="text" name="discount_single[]" onkeyup="multiply(<?php echo $i ?>)" id="discount_single<?php echo $i ?>" value="<?php echo $value['discount_single']; ?>" placeholder="Discount" class="form-control text-right" />
                                        <span class="text-danger"><?php echo form_error('discount_single[]'); ?></span>
                                    </td>
                                    <td class="text-right">
                                        <input type="text" name="amount[]" readonly id="amount_edit<?php echo $i ?>" placeholder="Amount" class="form-control text-right" value="<?php echo $value['amount']; ?>"/>
