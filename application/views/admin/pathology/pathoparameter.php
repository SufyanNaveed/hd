            ...
            <form id="formadd" action="<?php echo site_url('admin/pathologycategory/addparameter') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('reference') . " " . $this->lang->line('range'); ?></label>
                            <textarea name="reference_range" id="reference_range" rows="5" cols="10"  class="form-control" ></textarea>
                            <span class="text-danger"><?php echo form_error('reference_range'); ?></span>
                        </div>
            ...
            <form id="editformadd" action="<?php echo site_url('admin/pathologycategory/addparameter') ?>" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        ...
                        <div class="form-group">
                            <label for="exampleInputEmail1"><?php echo $this->lang->line('reference') . " " . $this->lang->line('range'); ?></label>
                            <textarea name="reference_range" id="reference_range" rows="5" cols="10"  class="form-control reference_range" ></textarea>
                            <span class="text-danger"><?php echo form_error('reference_range'); ?></span>
                        </div>
                       <!--   <div class="form-group">
                            <label for="exampleInputEmail1"><?php //echo $this->lang->line('unit') ; ?></label><small class="req"> *</small>
    ...
    function get(id) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('.reference_range').text(result.reference_range);
