                ...
                <div class="box-body pb0">
                    ...
                    <div class="col-md-10 col-lg-10 col-sm-9">
                        <div class="table-responsive">
                            <table class="custom-table table table-striped mb0 font13">
                                <tbody>
                                    <tr>
                                                    ...
                                                    <table class="custom-tablenobordertable table table-striped table-responsive">
                                                        ...
                                                        <?php if ($result['ipd_discharge'] != 'yes') { ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <span id="grass_amount_span" class="grass_amount_span">0</span></td>
    ...
    function checkbed(patient_id, billid, bedid,ipdid) {
        ...
        if (confirm('<?php echo $this->lang->line('are_you_sure')?>')) {
            $.ajax({
                ...
                type: "POST",
                data: {bed_id: bedid, patient_id: patient_id},
                dataType: 'json',
                success: function (res) {
