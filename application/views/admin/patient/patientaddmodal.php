                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <input id="mr_no" name="mr_no" placeholder="" type="text" class="form-control" value="<?php echo set_value('mr_no'); ?>" />
                                            <span class="text-danger"><?php echo form_error('mr_no'); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <div class="form-group">
                                            <label>Patient CNIC <small class="req"> *</small></label>
                                            <input type="text" name="patient_cnic" data-inputmask="'mask': '99999-9999999-9'" pattern="\d{5}-\d{7}-\d" placeholder="XXXXX-XXXXXXX-X" class="form-control config">
                                        </div>
                                    </div>
