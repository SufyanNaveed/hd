            ...
            <div class="col-md-12">
                <div class="">
                    ...
                    <table class="custom-tableprintablea4" width="100%">
                        <tr>
                            <th width="25%" ><?php echo "Operation Name" ?> </th>
                            <th width="25%" ><?php echo "Operation Date"; ?></th>
                            <th width="25%"><?php echo "Created At"?> </th>
                            <th width="25%"><?php echo "Out Time "?> </th>

                        </tr>

                        <?php
                        foreach ($ot_details as $key => $ot_detail) {
                            ?>

                            <tr>
                                <td><?php echo ucfirst($ot_detail["operation_name"]); ?></td>
                                <td><?php echo date($this->customlib->getSchoolDateFormat(), strtotime($ot_detail['date'])) ?></td>
                                <td><?php echo date('d/M/Y H:i:s',strtotime($ot_detail['created_at'])); ?></td>
                                <td><?php echo isset($ot_detail['out_time']) && $ot_detail['out_time']!=NULL? date('d/M/Y H:i:s',strtotime($ot_detail['out_time'])) : 'N/A'; ?></td>
                    ...
                    <table class="custom-tableprintablea4" width="100%">
                        <tr>
                            <th width="20%" ><?php echo $this->lang->line('charges') . ' (' . $currency_symbol . ')'; ?> </th>
                            <th width="20%" ><?php echo $this->lang->line('category'); ?></th>
                            <th width="20%"><?php echo $this->lang->line('standard') . " " . $this->lang->line('charge'); ?> </th>
                            <th width="20%"><?php echo $this->lang->line('date'); ?></th>
                            <th width="20%" class="pttright reborder text-right"><?php echo $this->lang->line('amount') . ' (' . $currency_symbol . ')'; ?> </th>
                        </tr>
                        <?php
                        $j = 0;
                        $total = 0;
                        ...
                        <tr>
                            <td></td>
                            <td></td>
                            <td><?php echo $this->lang->line('total') . " : " ?>  <?php echo $currency_symbol . $total_standard ?></td>
                            <td></td>
                    ...
                    <table class="custom-tableprintablea4" width="100%">
                        <tr>
                            ...
                            <th width="20%" ><?php echo $this->lang->line('item'); ?></th>
                            ...
                            <th width="15%"><?php echo $this->lang->line('created_at'); ?></th>

                        </tr>

                        <?php
                         $allPrice=0;
                        foreach ($items as $key => $medicine_prescription) {
                            $totalPrice=$medicine_prescription["purchasePrices"]['purchase_price'] * $medicine_prescription["quantity"];
                            $allPrice+= $totalPrice;
                            ?>

                            <tr>
                                <td><?php echo strtoupper($medicine_prescription["issue_type"]); ?></td>
                                ...
                                <td><?php echo date($this->customlib->getSchoolDateFormat(), strtotime($medicine_prescription['issue_date'])) ?></td>
