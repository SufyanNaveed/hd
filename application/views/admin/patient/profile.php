                                            ...
                                            if (!empty($opd_details)) {
                                                ...
                                                foreach ($opd_details as $key => $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo isset($value['next_visit']) && strtotime($value['next_visit']!==false) ? date('d M Y',strtotime($value['next_visit'])) : 'N/A'; ?>
                                                        </td>
                                                        <td><?php echo $value['opd_discount']; ?></td>
                                                        <td><?php echo isset($value['opd_discount']) && $value['opd_discount'] > 0 ? floor($value['amount'] - $value['opd_discount']) : floor($value['amount']); ?></td>
                                                        <td><?php echo $value['kpo_name']; ?></td>
                                                        <td>
                                                        <div class="form-group">
                                                            <select class="form-control" id="visit_status" onchange="updateVisitStatus('<?php echo $value['id'] ?>',this.value)">
                                                        <option value=''>Select Status</option>
                                                        <?php
                                                        foreach($optionArray as $optiondata){?>
                                                            <option value="<?php echo $optiondata ?>" <?php echo isset($value['visit_status']) && $value['visit_status']==$optiondata ? 'selected' : ''; ?>><?php echo ucfirst($optiondata)?></option>
                                                        }
                                                        <?php }?>
                                                        </select></div>
                                                        ...
                                                        <td class="text-right" width="70">
                                                            ...
                                                            <a href="#" onclick="refundRecord(<?php echo $value['id'] . ', \'refund\''; ?>)" class="btn btn-default btn-xs" data-toggle="tooltip" title="Refund"><i class="fas fa-hand-holding-usd" aria-hidden="true"></i></a>
