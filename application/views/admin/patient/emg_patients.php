                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <?php if ($title == 'old_patient') { ?>
                            <h3 class="box-title titlefix"><?php echo $this->lang->line('emg') . " " . $this->lang->line('old') . " " . $this->lang->line('patient') ?></h3>
                        <?php } else { ?>
                            <h3 class="box-title titlefix"><?php echo $this->lang->line('emg') . " " . $this->lang->line('patient') ?></h3>
            ...
            <div class="modal-body pt0 pb0">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <form id="formadd" accept-charset="utf-8" action="<?php echo base_url() . "admin/patient/save_emg_patient" ?>" enctype="multipart/form-data" method="post">
    ...
    function get_Charges(id) {
      ...
      //  console.log(id);
        $.ajax({
            ...
            type: "POST",
            data: {doctor: id, organisation: orgid,charges_type:'emg'},
            dataType: 'json',
            success: function (res) {
                if (res) {
...
function reloadPage()
{
    ...
    $("#formadd").on('submit', (function (e) {
            ...
            e.preventDefault();
            $.ajax({
                url: '<?php echo base_url(); ?>admin/patient/save_emg_patient',
                type: "POST",
                ...
                success: function (data) {
                    if (data.status == "fail") {
                        ...
                        if(print_option == 'A4'){
                            var emg='emg';
                            var base_url = '<?php echo base_url() ?>';
                            var url = base_url + 'admin/payment/printBillInvoice/'+patientid +'/'+data.opd_id+'/'+emg;
                            setTimeout(() => {
    ...
    function printprescriptionmanual(id='', opdid='') {
       //alert('hello');
        ...
        var emg='emg';
        $.ajax({
            url: base_url + 'admin/prescription/getPrescriptionmanual/' + id + '/' + opdid+ '/' +emg,
            type: 'POST',
...
<script type="text/javascript">
    ...
    $('.test_ajax').DataTable({
        ...
        "ajax": {
            "url": base_url+"admin/patient/emg_search",
            "type": "POST"
        },
         responsive: 'true',
         dom: "Bfrtip",
