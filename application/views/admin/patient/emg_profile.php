                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($opd_details)) {
                                                foreach ($opd_details as $key => $value) {
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <!-- <a href="<?php //echo base_url() . "admin/patient/visitDetails/" . $result["id"] . "/" . $value["id"] ?>"><?php //echo $value['emg_no']; ?></a> -->
                                                            <?php echo $value['emg_no']; ?>
                                                        </td>
                                                        ...
                                                        <td class="text-right" width="70">
                                                            ...
                                                            <a class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="delete_emgVisitById('<?php echo base_url('admin/patient/deleteEmgVisits').'/'.$value['id'].'/'.$result['id']?>', 'Record Deleted Successfully')" data-original-title="Delete">
