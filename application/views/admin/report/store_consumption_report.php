            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Department-wise Drug Utilization Report (Detailed report of drugs consumed by each department)</h3>
                    </div>
                    <form role="form" action="<?php echo site_url('admin/report/storeconsumptionreport') ?>" method="post" class="" onsubmit="return validateForm(event)">
