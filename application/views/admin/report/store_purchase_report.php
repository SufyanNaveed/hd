            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Purchase Stock Report</h3>
                    </div>
                    <form role="form" action="<?php echo  site_url('admin/report/storePurchaseStockReport') ?>" method="post" class="" onsubmit="return validateForm(event)">
...
<script type="text/javascript">
    ...
    function get_SupplierList(id) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>admin/admin/supplierList',
            type: "POST",
            data: {
                id: id
            },
