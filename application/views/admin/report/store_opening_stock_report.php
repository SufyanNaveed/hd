            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Store Opening Stock Report</h3>
                    </div>
                    <form role="form" action="<?php echo  site_url('admin/report/storeOpeningStockReport') ?>" method="post" class="" onsubmit="return validateForm(event)">
                                    ...
                                    ?>
                                        ...
                                        foreach ($resultlist as $bill) {
                                            if (!empty($bill['amount'])) {
                                                $total += $bill['approved_quantity'] * $bill['purchase_price'];
                                            }
                                        ?>
                                            <tr>
