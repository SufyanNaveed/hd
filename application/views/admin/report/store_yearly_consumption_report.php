            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Monthly Drug Consumption Summary (Yearly Overview Summary) (A month-wise summary of drug usage throughout the year)</h3>
                    </div>
                    <form role="form" action="<?php echo $is_stock ? site_url('admin/report/storeOpeningStockReport') : site_url('admin/report/storeyearlyconsumptionreport') ?>" method="post" class="" onsubmit="return validateForm(event)">
