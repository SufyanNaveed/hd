                            ...
                            <div class="box-group collapsed-box">                      
                                <div class="panel box box-success collapsed-box">
                                    ...
                                    <div class="box-body" style="padding: 0;">
                                        <div class="tshadow-new set_com" <?php if($staff["user_type"]=='Doctor'){ echo 'style=display:block';}else{echo 'style=display:none';}?> >    
                                            <h4 class="pagetitleh2"><?php echo 'Commission %'; ?></h4>
                                            <div class="row around10">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label><?php echo $this->lang->line('opd').' Commission(%)'; ?></label>
                                                        <input id="opd_com" name="opd_com" placeholder="" type="text" class="form-control"  value="<?php echo $staff["opd_commission"] ?>" />
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="ot_com" name="ot_com" placeholder="" type="text" class="form-control"  value="<?php echo $staff["ot_commission"] ?>"  />
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="emg_com" name="emg_com" placeholder="" type="text" class="form-control"  value="<?php echo $staff["emg_commission"] ?>" />
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="pathology_com" name="pathology_com" placeholder="" type="text" class="form-control"  value="<?php echo $staff["pathology_commission"] ?>"  />
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="ipd_com" name="ipd_com" placeholder="" type="text" class="form-control"  value="<?php echo $staff["ipd_commission"] ?>"  />
                                        ...
                                        <div class="tshadow-new">    
                                            ...
                                            <div class="row around10">
                                                ...
                                                <div class="col-md-4 commission" <?php if($staff["user_type"]=='Doctor'){ echo 'style=display:none';}else{echo 'style=display:block';}?>>
                                                    <div class="form-group">
                                                        <label><?php echo 'Commission(%)'; ?></label>
                                                        <input type="text" class="form-control" id="commission" name="commission" value="<?php echo $staff["commission"] ?>" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
