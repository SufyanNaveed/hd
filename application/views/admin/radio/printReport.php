...
<script type="text/javascript">
    ...
    function popup(data)
    {
        ...
        // Add style to create space from top in the printed page
        frameDoc.document.write('<style>');
        frameDoc.document.write('@media print {');
        frameDoc.document.write('  body { margin: 0; }'); // Reset body margins

        // Define margins for first page and subsequent pages
        frameDoc.document.write('  @page { margin: 200px 80px 0 80px; }'); // First page margin
        //frameDoc.document.write('  @page :first { margin: 0; }'); // Reset first page margin
