        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="">
                    ...
                    <table width="100%" class="printablea4">
                        <tr>
                            <td align="text-left"><h5>
                                <?php echo $this->lang->line('bill') . " #"; ?><?php echo $result["bill_no"] ?><br>
                    ...
                    <table class="custom-tableprintablea4" cellspacing="0" cellpadding="0" width="100%" border="0">
                    <thead>
                        <tr>
                            <th width="10%"><?php echo $this->lang->line('name'); ?></th>
                            <th width="20%"><?php echo $this->lang->line('doctor'); ?></th>
                            <th width="20%"><?php echo $this->lang->line('test') . " " . $this->lang->line(''); ?></th>
                            <!--<th width="20%"><?php echo $this->lang->line('short') . " " . $this->lang->line('name'); ?></th>-->
                            <!--<th width="20%"><?php echo $this->lang->line('discount') ; ?></th>-->
                        ...
                        foreach ($detail as $bill) {
                            ?>
                                ...
                                <!--<td><?php echo $result["radio_discount"]; ?></td>-->
                                <td><?php echo $currency_symbol . "" . isset($result["radio_discount"]) && $result["radio_discount"] > 0 ? $result["apply_charge"] - $result["radio_discount"] : $result["apply_charge"] ; ?></td>
                    ...
                    <!-- <table class="custom-tableprintablea4" id="testreport" width="100%">
                        ...
                        foreach ($detail as $bill) {
                            ?>
                                ...
                                <td><?php //echo $result["radio_discount"]; ?></td>
                                <td class="pull-right"><?php //echo $currency_symbol . "" . isset($result["radio_discount"]) && $result["radio_discount"] > 0 ? $result["apply_charge"] - $result["radio_discount"] : $result["apply_charge"] ; ?></td>
                            <?php
                            $i++;
                        }
                        ?>
