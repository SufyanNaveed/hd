            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('attendance') . " " . $this->lang->line('report'); ?></h3>
                    </div>
                    <form role="form" action="<?php echo site_url('admin/staffattendance/bioreport') ?>" method="post" class="">
...
?> name="doctor" style="width: 100%">
    ...
    ?>
                                            <option value="<?php echo $value["bio_id"] ?>" <?php
                                            if ((isset($doctor_select)) && ($doctor_select == $value["bio_id"])) {
                                                    echo "selected";
                                                }
                                                ?> ><?php echo $value["bio_id"] ?></option>
                                            <?php }?>
                                    </select>
                    ...
                    <div class="box border0 clear">
                        ...
                        <div class="box-body table-responsive">
                            ...
                            <table class="custom-table table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr>
                                        <th><?php echo "Bio ID"; ?></th>
                                        <th><?php echo $this->lang->line('date'); ?></th>
                                        <th><?php echo 'Time Status'; ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    if (empty($resultlist)) {
                                        ...
                                        <?php
                                            ...
                                            foreach ($resultlist as $appointment) {
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?php echo $appointment['bio_id']; ?></td>
                                                        <td><?php echo date($this->customlib->getSchoolDateFormat(true, true), strtotime($appointment['push_time'])) ?></td>
                                                        <td><?php echo ucfirst($appointment['time_status']); ?></td>
