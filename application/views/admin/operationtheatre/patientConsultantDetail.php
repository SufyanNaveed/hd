...
<table class="custom-table table table-striped table-bordered table-hover example" id="otreport" cellspacing="0" width="100%" >
    <thead>
        <tr>
    ...
    <tbody>
        <?php
        $count = 1;
        foreach ($ot_medicine as $prescription_key => $medicine_prescription) {
            ?>
            <tr>
