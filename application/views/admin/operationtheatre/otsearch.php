                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix">
                            <?php echo $this->lang->line('operation_theatre') . " " . $this->lang->line('patient'); ?>
                        </h3>
                        <div class="box-tools pull-right">
                            ...
                            <a data-toggle="modal" onclick="holdModal('myModal')"
                                ...
                                <?php echo $this->lang->line('add') . " " . $this->lang->line('patient'); ?></a>
                            <?php } ?>
                        </div>
                    </div><!-- /.box-header -->
                    <?php
                        ...
                        <table class="custom-table table table-striped table-bordered table-hover test_ajax" cellspacing="0"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo $this->lang->line('operation') . " " . $this->lang->line('name'); ?>
                                    </th>
                                    <th><?php echo $this->lang->line('operation') . " " . $this->lang->line('type'); ?>
                                    </th>
...
<div class="modal fade" id="myModal" role="dialog" aria-labelledby="myModalLabel">
            ...
            <div class="modal-header modal-media-header">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-xs-5">
                        <div class="form-group15"><?php if ($this->rbac->hasPrivilege('patient', 'can_add')) { ?><a
                                data-toggle="modal" id="addpip" onclick="holdModal('myModalpa')"
            ...
            <div class="modal-body pt0 pb0">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <form id="formadd" name="formadd" accept-charset="utf-8"
                            action="<?php echo base_url("admin/patient/add_inpatient") ?>" enctype="multipart/form-data"
                            method="post">
                            <input id="patientuniqueid" name="patient_unique_id" placeholder="" type="hidden"
                                class="form-control" value="<?php echo set_value('patient_unique_id'); ?>" />
                            <input id="patientidot" name="patient_id" placeholder="" type="hidden" class="form-control"
                                value="" />
                            <input id="patientname" name="patientname" placeholder="" type="hidden" class="form-control"
                                value="" />
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-3">
                                            <div class="pull-right">
                                                ...
                                                <img class="profile-user-img img-responsive"
                                                    src="<?php echo base_url() . $file ?>" id="image"
                                ...
                                <div class="col-lg-5 col-md-5 col-sm-5 col-eq ptt10">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label
                                                    for="operation_name --r"><?php echo $this->lang->line('operation') . " " . $this->lang->line('name'); ?></label>
                                                <small class="req"> *</small>
                                                <input id="number" autocomplete="off" name="operation_name"
                                                    placeholder="" type="text" class="form-control" />
                                                <span
                                                    class="text-danger"><?php echo form_error('operation_name'); ?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <span
                                                    class="text-danger"><?php echo form_error('operation_type'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div><select class="form-control select2" <?php
                                                    ...
                                                    ?> style="width:100%" id='consultant_doctorid'
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputFile"><?php echo $this->lang->line('organisation'); ?></label>
                                                <div>
    ...
    ?>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <small class="req">*</small>
                                                <div>
                                                    <select class="form-control" onchange="getchargecode(this.value)"
    ...
    ?>
                                                ...
                                                <span
                                                    class="text-danger"><?php echo form_error('charge_category_id'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputFile"><?php echo $this->lang->line('code'); ?></label>
                                                <small class="req">*</small>
                                                <div>
                                                    <select class="form-control" name='code'
                                                        onchange="getchargeDetails(this.value, 'standard_charge')"
                                                        id="code">
                                                        <option value=""><?php echo $this->lang->line('select') ?>
                                                        </option>
                                                    </select>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label
                                                    for="exampleInputFile"><?php echo $this->lang->line('applied') . ' ' . $this->lang->line('charge'); ?></label><?php echo ' (' . $currency_symbol . ')'; ?>
                                                <small class="req">*</small>
                                                <div>
                                                    <input class="form-control" type="text" name="apply_charge"
                                                        id="apply_charge" />
                            ...
                            <div class="row">
                                <div class="box-footer">
                                    ...
                                    <div class="pull-right" style="margin-right:10px;">
                                        <button type="button"
                                            data-loading-text="<?php echo $this->lang->line('processing') ?>"
                                            class="btn btn-info pull-right printsavebtn"><?php echo $this->lang->line('save_print'); ?></button>
                                    </div>
                                </div>
                            </div>
                            <!--./row-->
...
<div class="modal fade" id="myModaledit" role="dialog" aria-labelledby="myModalLabel">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="row ptt10" id="epatientDetails" style="display:none">
                                                ...
                                                <ul class="multilinelist">
                                                    ...
                                                    <li>
                                                        <i class="fas fa-tint" data-toggle="tooltip"
                                                            data-placement="top" title="Blood Group"></i>
                                                        <span id="eblood_group"></span>
                                                    </li>
                                                    <li>
                                                        <i class="fas fa-ring" data-toggle="tooltip"
                                                            data-placement="top" title="Marital Status"></i>
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-3">
                                                <div class="pull-right">
                                                    ...
                                                    ?>
                                                    <img class="profile-user-img img-responsive"
                                                        src="<?php echo base_url() . $file ?>" id="eimage"
                                                        alt="User profile picture">
                                                </div>
                                            </div><!-- ./col-md-3 -->
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2 col-xs-4">
                                                <div class="form-group">
                                                    <label for="pwd"><?php echo $this->lang->line('height'); ?></label>
                                                    <input name="height" id="eheight" type="text"
                                                        class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-sm-2 col-xs-4">
                                                <div class="form-group">
                                                    <label for="pwd"><?php echo $this->lang->line('weight'); ?></label>
                                                    <input name="weight" id="eweight" type="text"
                                                        class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-sm-2 col-xs-4">
                                            ...
                                            <div class="col-sm-2 col-xs-4">
                                                <div class="form-group">
                                                    ...
                                                    <input name="temperature" id="etemperature" type="text"
                                                        class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-sm-2 col-xs-4">
                                                <div class="form-group">
                                                    ...
                                                    <input name="respiration" id="erespiration" type="text"
                                                        class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-sm-3 col-xs-4">
                                            ...
                                            <div class="col-sm-12 col-lg-6">
                                                <div class="form-group">
                                                    <label
                                                        for="email"><?php echo $this->lang->line('symtoms')." ".$this->lang->line('description'); ?></label>
                                                    <textarea row="3" name="symptoms" id="esymptoms"
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <label for="pwd"><?php echo $this->lang->line('note'); ?></label>
                                                    <textarea name="note" id="view_note" rows="3"
                                                        class="form-control"><?php echo set_value('note'); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <input id="epatients_id" name="patientid" type="hidden" class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <small class="req"> *</small>
                                                <input type="text" value="<?php echo set_value('date'); ?>" id="dates"
                                                    name="date" class="form-control date" autocomplete="off">
                                                <span class="text-danger"><?php echo form_error('date'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label
                                                    for="operation_name --r"><?php echo $this->lang->line('operation') . " " . $this->lang->line('name'); ?></label>
                                                <small class="req"> *</small>
                                                <input id="operation_name" autocomplete="off" name="operation_name"
                                                    type="text" class="form-control"
                                                    value="<?php echo set_value('operation_name'); ?>" />
                                                <span
                                                    class="text-danger"><?php echo form_error('operation_name'); ?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="operation_type"
                                                    value="<?php echo set_value('operation_type'); ?>"
                                                    name="operation_type" class="form-control">
                                                <span
                                                    class="text-danger"><?php echo form_error('operation_type'); ?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="ass_consultant_1"
                                                    value="<?php echo set_value('ass_consultant_1'); ?>"
                                                    name="ass_consultant_1" class="form-control">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('assistent') . " " . $this->lang->line('consultant') . " " . '2'; ?></label>
                                                <input type="text" id="ass_consultant_2"
                                                    value="<?php echo set_value('ass_consultant_2'); ?>"
                                                    name="ass_consultant_2" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="anesthetist"
                                                    value="<?php echo set_value('anesthetist'); ?>" name="anesthetist"
                                                    class="form-control">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('anaethesia') . " " . $this->lang->line('type'); ?></label>
                                                <input type="text" id="anaethesia_type"
                                                    value="<?php echo set_value('anaethesia_type'); ?>"
                                                    name="anaethesia_type" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="ot_technician"
                                                    value="<?php echo set_value('ot_technician'); ?>"
                                                    name="ot_technician" class="form-control">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="ot_assistant"
                                                    value="<?php echo set_value('ot_assistant'); ?>" name="ot_assistant"
                                                    class="form-control">
    ...
    ?>
                                                ...
                                                <span
                                                    class="text-danger"><?php echo form_error('charge_category_id'); ?>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <small class="req">*</small>
                                                <div>
                                                    <input class="form-control" readonly="" name='standard_charge'
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <small class="req">*</small>
                                                <div>
                                                    <input class="form-control" name='apply_charge'
                                                        id="edit_apply_charge">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input type="checkbox" class="form-check-input" name="out_patient">
                                                <label class="form-check-label" for="exampleCheck1">Out Patient
                                                </label>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                ...
                <h4 class="box-title">
                    <?php echo $this->lang->line('operation') . " " . $this->lang->line('information'); ?></h4>
            </div>
            <div class="modal-body pt0 pb0">
                <div class="row">
                            ...
                            <div class="table-responsive">
                                <div class="col-md-6">
                                    <table class="custom-tableprintablea4 examples">
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo $this->lang->line('patient') . " " . $this->lang->line('id'); ?>
                                            </th>
                                ...
                                <div class="col-md-6">
                                    <table class="custom-tableprintablea4 examples">
                                        ...
                                        <tr>
                                            <th><?php echo $this->lang->line('consultant') . " " . $this->lang->line('doctor'); ?>
                                            </th>
                                            <td><span id='cons_doctors'></span></td>
                                        </tr>
                                        <tr>
                                            <th><?php echo $this->lang->line('assistent') . " " . $this->lang->line('consultant') . " " . '1'; ?>
                                            </th>
                                            <td><span id="ass_consultants_1"></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th><?php echo $this->lang->line('assistent') . " " . $this->lang->line('consultant') . " " . '2'; ?>
                                            </th>
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo $this->lang->line('anaethesia') . " " . $this->lang->line('type'); ?>
                                            </th>
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo $this->lang->line('ot') . " " . $this->lang->line('technician'); ?>
                                            </th>
                                        ...
                                        <tr>
                                            <th><?php echo $this->lang->line('ot') . " " . $this->lang->line('assistent'); ?>
                                            </th>
                                        ...
                                        <tr>
                                        <tr>
                                            <th><?php echo $this->lang->line('charge') . " " . $this->lang->line('category'); ?>
                                            </th>
                                            <td><span id="charge_categorys"></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th><?php echo $this->lang->line('code') . " (" . $this->lang->line('description') . ")"; ?>
                                            </th>
                                        ...
                                        <th><?php echo $this->lang->line('applied') . " " . $this->lang->line('charge') . ' (' . $currency_symbol . ')'; ?>
                                        </th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title">
                    <?php echo $this->lang->line('consultant') . " " . $this->lang->line('instruction'); ?></h4>
            </div>
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="custom-table table tableover table-striped table-bordered table-hover"
                                        id="tableID">
                                        <tr>
                                            <th><?php echo $this->lang->line('applied') . " " . $this->lang->line('date') ?><small
                                                    style="color:red;"> *</small></th>
                                            <th><?php echo $this->lang->line('consultant') ?><small style="color:red;">
                                                    *</small></th>
                                            <th><?php echo $this->lang->line('instruction') ?><small style="color:red;">
                                                    *</small></th>
                                            <th><?php echo $this->lang->line('instruction') . " " . $this->lang->line('date'); ?><small
                                                    style="color:red;"> *</small></th>
                                        ...
                                        <tr id="row0">
                                            ...
                                            <td>
                                                <textarea style="height:28px" name="instruction[]"
                                                    class="form-control"></textarea>
                                            </td>
                                            <td>
                                                <input
                                                    value="<?php echo set_value('date', date($this->customlib->getSchoolDateFormat())); ?>"
                                                    type="text" name="insdate[]" class="form-control date">
                                            </td>

                                            <td><button type="button" onclick="add_more()" style="color:#2196f3"
                                                    class="closebtn"><i class="fa fa-plus"></i></button></td>
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#edit_deletebill').html(
                "<?php if ($this->rbac->hasPrivilege('operationtheatre bill', 'can_view')) { ?><a href='#' data-toggle='tooltip' onclick='printData(" +
                id +
                ")'   data-original-title='<?php echo $this->lang->line('print'); ?>'><i class='fa fa-print'></i></a> <?php } ?><?php if ($this->rbac->hasPrivilege('operationtheatre bill', 'can_edit')) { ?><a href='#'' onclick='getRecord(" +
                id +
                ")' data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a><?php } ?><?php if ($this->rbac->hasPrivilege('operationtheatre bill', 'can_edit')) { ?><a onclick='delete_bill(" +
                id +
...
function getPatientIdName(opd_ipd_no) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('select[id="patientsgender"] option[value="' + data.gender + '"]').attr("selected",
                "selected");
        }
    });
}
...
$(document).ready(function() {
    $("#birth_date").change(function() {
        ...
        if (isNaN(year_age) || isNaN(month_age) || isNaN(day_age)) {
            ...
            $("#exact_age").html("You are<br/><span id=\"age\">" + year_age + " years " + month_age +
                " months " + day_age + " days</span> old");
...
function getRecord(id) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('select[id="edit_organisation"] option[value="' + data.organisation + '"]').attr("selected",
                "selected");
...
function viewDetail(id) {
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#edit_delete').html(
                "<?php if ($this->rbac->hasPrivilege('ot_patient', 'can_edit')) { ?><a href='#'' onclick='getRecord(" +
                data.id +
                ")' data-target='#editModal' data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a><?php } if ($this->rbac->hasPrivilege('ot_patient', 'can_delete')) { ?><a href='#' data-toggle='tooltip'  onclick='delete_record(" +
                data.id + "," + id +
