                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('organisation', 'can_add')) { ?>
                                <a href="<?php echo base_url(); ?>admin/tpamanagement/deductionreport" class="btn btn-primary btn-sm organisation"><i class="fa fa-database"></i> Deduction Report</a> 
                                                ...
                                                <td>
                                                    ...
                                                    <div class="rowoptionview">
                                                        ...
                                                        <?php } if ($this->rbac->hasPrivilege('organisation', 'can_edit')) { ?>
                                                            ...
                                                            <a href="#" class="btn btn-default btn-xs" onclick="get_paydata('<?php echo $org['id']; ?>')"  data-toggle="tooltip"  title="View Balance" >
                                                                <i class="fa fa-eye"></i>
                                                            </a>
...
<div class="modal fade" id="balanceModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="box-title">TPA Balance Details</h4> 
            </div>
                        ...
                        <form id="formedit" accept-charset="utf-8" enctype="multipart/form-data" method="post" class="ptt10">
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('name'); ?></label><small class="req"> *</small> 
                                        <input id="org_name" name="org_name" placeholder="" type="text" class="form-control"  value="<?php echo set_value('name'); ?>" autocomplete="off" readonly />
                                    </div>
                                </div>
                            </div><!--./row-->
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Total Lodged Amount</label><small class="req"> *</small> 
                                        <input id="lodged_amount" name="lodged_amount" placeholder="" type="text" class="form-control"  value="<?php echo set_value('lodged_amount'); ?>" autocomplete="off" readonly />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Total Approved Amount</label><small class="req"> *</small> 
                                        <input id="approved_amount" name="approved_amount" placeholder="" type="text" class="form-control"  value="<?php echo set_value('approved_amount'); ?>" autocomplete="off" readonly />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Total Released Amount</label><small class="req"> *</small> 
                                        <input id="released_amount" name="released_amount" placeholder="" type="text" class="form-control"  value="<?php echo set_value('released_amount'); ?>" autocomplete="off" readonly />
                                    </div>
                                </div>
                            </div><!--./row-->
                    </div><!--./col-md-12-->       
...
<script type="text/javascript">
    ...
    function get_paydata(id) {
        $('#balanceModal').modal('show')
        $.ajax({
            url: '<?php echo base_url(); ?>admin/tpamanagement/pay_data/' + id,
            dataType: 'json',
            success: function (res) {
                $('#org_id').val(res.org_id);
                $('#org_name').val(res.org_name);
                $('#lodged_amount').val(res.lodged_amount);
                $('#approved_amount').val(res.approved_amount);
                $('#released_amount').val(res.released_amount);
            }
        });
    }
    $(function () {
