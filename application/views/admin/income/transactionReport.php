    ...
    ?>
                                            ...
                                            <div class="col-sm-6 col-md-6" >
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="kpoid" >
                                                        <option value=""><?php echo $this->lang->line('all') ?></option>
                                                        <?php foreach ($kpo_filterData as $key => $kpoName) {
                                                                ?>
                                                            <option value="<?php echo $key ?>"
                                                            <?php
                                                                if ((isset($kpo_type)) && ($kpo_type == $key)) {
                                                                        echo "selected";
                                                                    }
                                                                ?>
                                                            ><?php echo $kpoName ?></option>
                                                            <?php }?>
                                                    </select>
...
$dis=isset($result["radio_discount"]) && !empty($result["radio_discount"]) ? $result["radio_discount"] : 0;
                $payment = $result["amount"] - $dis;
...
$tot[$value["label"]] = 0;
        foreach ($value["resultList"] as $key2 => $transaction) {
            ...
            if (!empty($transaction["amount"])) {
                $diss=isset($transaction["radio_discount"]) && !empty($transaction["radio_discount"]) ? $transaction["radio_discount"] : 0;
                $payment = $transaction["amount"] - $diss;
