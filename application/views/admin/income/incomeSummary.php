...
<div class="content-wrapper" style="min-height: 946px;">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo "Income Summary" ?></h3>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <form role="form" action="<?php echo site_url('admin/income/incomeSummary') ?>" method="post" class="">
    ...
    ?>
                                            ...
                                            <div class="col-sm-4 col-md-4" >
                                                <div class="form-group">
                                                    <label><?php echo $this->lang->line('search') . " " . " Heads "; ?></label>
                                                    <select class="form-control select2 head_select" name="head_select[]" multiple >
                                                        <option value=""><?php echo $this->lang->line('all') ?></option>
                                                        <?php foreach ($fillter_language_module as $key => $fillter_language) {
                                                                ?>
                                                            <option value="<?php echo $key ?>"
                                                            <?php
                                                                $selected='';
                                                                if (in_array($key, $head_select)){
                                                                    echo $selected='selected';
                                                                }
                                                                ?>
                                                            ><?php echo $fillter_language ?></option>
                                                            <?php }?>
                                                    </select>
                                                    <span class="text-danger"><?php echo form_error('head_select'); ?></span>
                                                </div>
                                            </div>
