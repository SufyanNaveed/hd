            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo "Income Report" ?></h3>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <form role="form" action="<?php echo site_url('admin/income/incomereport') ?>" method="post" class="">
                                        ...
                                        <table class="custom-table table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right <?php echo $class ?>">
                                                                        <?php
                                                                            if($result["status"] == 'refund') {
                                                                                echo $prefix . number_format($t_amt);
                                                                            }
                                                                        ?>
                                                                    </td>
                                                ...
                                                <tr class="box box-solid total-bg">
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td class="text-right"><?php echo  $currency_symbol . ($total+$total_refund); ?></td>
                                                    ...
                                                    <td class="text-right"><?php echo  $currency_symbol . $total_refund; ?></td>
                                                    <td></td>
                                                    <td></td>
