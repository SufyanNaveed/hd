...
$fillter_language_module = array(
    'OPD'=> 'Opd Patient',
    'OPD Private'=> 'Opd Private Patient',
    'IPD'=> 'Ipd Patient',
    'Pharmacy'=> 'Pharmacy Bill',
    'Pathology'=> 'Pathology Test',
    'Radiology'=> 'Radiology Test',
    'Operation Theatre'=> 'Ot Patient',
    'Ambulance'=> 'Ambulance Call',
    'Blood Bank'=> 'Blood Issue',
...
<div class="content-wrapper" style="min-height: 946px;">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo 'KPO Cash Collection Summary' ?></h3>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <form role="form" action="<?php echo site_url('admin/income/filltertransaction') ?>" method="post" class="">
    ...
    ?>
                                            ...
                                            <div class="col-sm-4 col-md-4" >
                                                <div class="form-group">
                                                    <label><?php echo $this->lang->line('search') . " " . " Kpo "; ?></label>
                                                    <select class="form-control select2 head_select" name="kpoid[]" multiple>
                                                        <option value="" ><?php echo $this->lang->line('all') ?></option>
                                                        <?php foreach ($kpo_filterData as $key => $kpoName) {
                                                                ?>
                                                            <option value="<?php echo $kpoName['kpo_id'] ?>"
                                                            <?php
                                                                if ((isset($kpo_type)) && ($kpo_type == $kpoName['kpo_id'])) {
                                                                        echo "selected";
                                                                    }
                                                                if ((isset($kpo_type)) && (in_array($kpoName['kpo_id'], $kpo_type))) {
                                                                        echo "selected";
                                                                    }
                                                                ?>
                                                            ><?php echo $kpoName['kpo_name'] ?></option>
                                                            <?php }?>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <button type="submit" name="search" value="search_filter" class="btn btn-primary btn-sm checkbox-toggle pull-right" style="margin-left: 6px;"><i class="fa fa-search"></i> <?php echo $this->lang->line('search'); ?></button>
                                                    <button type="submit" name="search" value="search_excel" class="btn btn-warning btn-sm checkbox-toggle pull-right "><i class="fa fa-search"></i> <?php echo 'Export'; ?></button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="tab-pane active" id="all">
                                    ...
                                    <div class="table-responsive">
                                        <table class="custom-table table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                            ...
                                            <th style="text-align: right;"><?php echo 'Doctor Name'; ?></th>
        ...
        foreach ($value["resultList"] as $key2 => $transaction) {
            ...
            ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-right"><?php echo $transaction["kpo_name"] ?></td>
...
<script type="text/javascript">
    ...
    $('.head_select').on("select2:select", function (e) {
    var data = e.params.data.text;
    if (data == 'All') {
        // Select all options using Select2's `val` method
        $(".head_select").val($(".head_select option").map(function () {
            return this.value;
