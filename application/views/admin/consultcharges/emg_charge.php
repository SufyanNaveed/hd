                ...
                <div class="box border0">
                    <ul class="tablists">
                        ...
                        <?php if ($this->rbac->hasPrivilege('doctor_opd_charges', 'can_view')) {?>
                            ...
                            <li><a href="<?php echo base_url(); ?>admin/consultcharges/emg" class="active"><?php echo $this->lang->line('doctor') . " " . $this->lang->line('emg') . " " . $this->lang->line('charge'); ?></a></li>  <?php }?>
            ...
            <div class="col-md-10">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix"><?php echo $this->lang->line('doctor') . " " . $this->lang->line('emg') . " " . $this->lang->line('charge'); ?></h3>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 paddlr">
                        <form id="formadd" accept-charset="utf-8" method="post" class="ptt10">
                            <input type="hidden" name="charges_type" id="charges_type" value="emg">
                            <div class="row">
...
<script type="text/javascript">
    ...
    $(document).ready(function (e) {
        $("#formadd").on('submit', (function (e) {
            ...
            e.preventDefault();
            $.ajax({
                url: '<?php echo base_url(); ?>admin/consultcharges/addEmgConsultantCharges',
                type: "POST",
