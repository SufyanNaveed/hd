                ...
                <div class="box border0">
                    <ul class="tablists">
                        ...
                        <?php if ($this->rbac->hasPrivilege('doctor_opd_charges', 'can_view')) {?>
                            <li><a href="<?php echo base_url(); ?>admin/consultcharges" class="active"><?php echo $this->lang->line('doctor') . " " . $this->lang->line('opd') . " " . $this->lang->line('charge'); ?></a></li>
                            <li><a href="<?php echo base_url(); ?>admin/consultcharges/emg" ><?php echo $this->lang->line('doctor') . " " . $this->lang->line('emg') . " " . $this->lang->line('charge'); ?></a></li>  <?php }?>
            ...
            <div class="modal-body pt0 pb0">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 paddlr">
                        ...
                        <input type="hidden" name="charges_type" id="charges_type" value="opd">
                            <div class="row">
    ...
    function getRecord(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#updateid").val(id);
                $("#doctor_percentage_type").val(data.doctor_percentage_type);
                $("#doctor_percentage").val(data.percentage_amount);
                var staffArray = data.all_staff;
    ...
    function viewDetail(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                console.log(data.doctor_percentage_type,"data.doctor_percentage_type");
