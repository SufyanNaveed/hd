                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="custom-table table table table tableover table-striped table-bordered table-hover mb10 tablefull12" id="tableID">
                                                            <tr>
                                                                ...
                                                                <th width="18%"><?php echo $this->lang->line('batch') . " " . $this->lang->line('no'); ?><small style="color:red;"> *</small></th>
                                                            ...
                                                            <tr id="row0">
                                                                ...
                                                                <td>
                                                                    <!-- Dropdown -->
                                                                    <div id="batch_select_container0">
                                                                    ...
                                                                    <!-- Text Input + Back link -->
                                                                    <div id="batch_input_container0" style="display: none;">
                                                                        <div style="display: flex; gap: 5px;">
                                                                            <input type="text" id="batch_input0" class="form-control" onblur="getExpire(0)">
                                                                            <button type="button" class="btn btn-sm btn-secondary" onclick="backToSelect(0)">Back</button>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <input type="text" name="expiry_date[]" id="expiry_date0" class="form-control expiry">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function submitBillForm(btn) {
            ...
            $.ajax({
                url: "<?php echo base_url(); ?>hospital/pharmacy/addOpeningStock",
                type: "POST",
                data: formData,
                dataType: "json",
                contentType: false,
    ...
    <div id="batch_select_container${id}">
        <select class="form-control" name="batch_no[]" id="batch_no${id}" onchange="getExpire(${id})">
            <option value=""><?php echo $this->lang->line('select') ?></option>
    ...
    <span class="text-danger"><?php echo form_error('batch_no[]'); ?></span>
                ...
                <td><input type='text' name='expiry_date[]' id='expiry_date${id}' class='form-control expiry_date expiry'></td>
                <td>
                    <div class='input-group'>
    ...
    function backToSelect(id) {
        ...
        $("#batch_no" + id).val(""); // Reset selection
    }
        ...
        $.ajax({
            ...
            success: function(res) {
                if (res != null) {
                    ...
                    $('#purchase_price' + id).val(res.purchase_price);
                    getQuantity(id);
                }
            }
        });
