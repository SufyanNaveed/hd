            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix">Opening Stock</h3>
                        <div class="box-tools pull-right">
                                <a data-toggle="modal" href="<?php echo base_url(); ?>hospital/store/addOpeningStock" class="btn btn-primary btn-sm addpurchase"><i class="fa fa-plus"></i>Add Opening Stock</a> 
...
<script>
        ...
        // } 
            ...
            function viewDetail(id, status) {
                ...
                $.ajax({
                    url: '<?php echo base_url() ?>hospital/pharmacy/getOpeningStockDetail/' + id,
                    type: "GET",
                    data: {id: id},
                    success: function (data) {
