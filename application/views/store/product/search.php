                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label>Formula</label>
                                        <small class="req"> *</small> 
                                        <input id="medicine_name" name="formula" placeholder="" type="text" class="form-control"/>
                                        <span class="text-danger"><?php echo form_error('formula'); ?></span>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="exampleInputFile">
                                            <?php echo $this->lang->line('medicine') . " " . $this->lang->line('company'); ?></label>
                                        <small class="req"> *</small> 
                                        <div>
                                            <select class="form-control select2" style="width:100%" name='medicine_company_id' >
                                                <option value="<?php echo set_value('medicine_company_id'); ?>"><?php echo $this->lang->line('select') ?>
                                                </option>
                                                <?php foreach ($medicineCompanies as $dkey => $dvalue) {
                                                    ?>
                                        ...
                                        <span class="text-danger"><?php echo form_error('medicine_company_id'); ?></span>
                                    </div>
                                </div>  
                                <div class="col-sm-3">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="exampleInputFile">
                                            <?php echo $this->lang->line('medicine') . " " . $this->lang->line('category'); ?></label>
                                        <small class="req"> *</small> 
                                        <div><select class="form-control select2 medicines_category_id" style="width:100%" name='medicine_category_id' id="medicines_category_id" >
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <small class="req"> *</small> 
                                        <select class="form-control select2" id="edit_medicine_company_id" style="width:100%" name='medicine_company_id' >
                                                <option value="<?php echo set_value('medicine_company_id'); ?>"><?php echo $this->lang->line('select') ?>
                                                </option>
                                                <?php foreach ($medicineCompanies as $dkey => $dvalue) {
                                                    ?>
...
<script type="text/javascript">
            $(document).ready(function (e) {
                $("#formadd").on('submit', (function (e) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url(); ?>hospital/pharmacy/addProduct',
                        type: "POST",
            ...
            /*	$(document).ready(function (e) {
             ...
             $.ajax({
             url: '<?php echo base_url(); ?>hospital/pharmacy/import',
             type: "POST",
             data: new FormData(this),
             dataType: 'json',
             contentType: false,
            ...
            $(document).ready(function (e) {
                $("#formstock").on('submit', (function (e) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url(); ?>hospital/pharmacy/addBadStock',
                        type: "POST",
                        data: new FormData(this),
                        dataType: 'json',
                        contentType: false,
            ...
            $(document).ready(function (e) {
                $("#formedit").on('submit', (function (e) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url(); ?>hospital/pharmacy/updateProduct',
                        type: "POST",
                        data: new FormData(this),
                        dataType: 'json',
                        contentType: false,
            ...
            function getRecord(id) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $("#edit_medicine_company_id").val(data.medicine_company_id).trigger('change');
            ...
            function viewDetail(id) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        // $.ajax({
                        //     url: '<?php echo base_url(); ?>hospital/pharmacy/getMedicineBatch',
                        //     type: "POST",
                        //     data: {pharmacy_id: id},
                        //     success: function (data) {
                        //         $('#tabledata').html(data);
                ...
                $("#medicine_barcode").html("<p>No Barcode Available</p>");
                        ...
                        $('#edit_delete').html("<a href='#'' onclick='getRecord(" + id + ")' data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a><a onclick='delete_record(" + id + ")'  href='#'  data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('delete'); ?>'><i class='fa fa-trash'></i></a>");
                        holdModal('viewModal');
                    },
                });
            }
            function addBulk(id) {
                $.ajax({
                    url: '<?php echo base_url(); ?>hospital/pharmacy/getPharmacy',
                    type: "POST",
                    data: {pharmacy_id: id},
                    dataType: 'json',
                    success: function (data) {
            ...
            $(document).ready(function (e) {
                $("#formbatch").on('submit', (function (e) {
                    ...
                    $.ajax({
                        url: '<?php echo base_url(); ?>hospital/pharmacy/medicineBatch',
                        type: "POST",
                        data: new FormData(this),
                        dataType: 'json',
                        contentType: false,
            ...
            function delete_record(id) {
                if (confirm('Are you sure')) {
                    $.ajax({
                        url: '<?php echo base_url(); ?>hospital/pharmacy/delete/' + id,
                        type: "POST",
                        data: {opdid: ''},
                        dataType: 'json',
                        success: function (data) {
...
<script type="text/javascript">
    ...
    $('.test_ajax').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": base_url+"hospital/pharmacy/product_search",
            "type": "POST",
