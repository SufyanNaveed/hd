            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Patient Summary report</h3>
                    </div>
                    <form role="form" action="<?php echo site_url('hospital/report/patientSummaryReport') ?>" method="post" class="" onsubmit="return validateForm(event)">
                        <div class="box-body row">
                            ...
                            <div class="col-sm-4 col-md-4">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('search') . " " . " Patient Type "; ?></label>
                                    <select class="form-control select2 " id="patient_type" name="patient_type">
                                        <option value=""><?php echo "Select Patient Type" ?></option> 
                                        <option value="national" <?php echo isset($selected_patient_type) && $selected_patient_type == 'national' ? 'selected' : '' ?>><?php echo "National" ?></option> 
                                        <option value="other_national" <?php echo isset($selected_patient_type) && $selected_patient_type == 'other_national' ? 'selected' : '' ?>><?php echo "Other National" ?></option> 
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4 col-md-4">
                                <div class="form-group">
                                    <label><?php echo $this->lang->line('search') . " " . " Gender "; ?></label>
                                    <select class="form-control select2 " id="gender" name="gender">
                                        <option value=""><?php echo "Select Gender" ?></option>
                                        <option value="male" <?php echo isset($selected_gender) && $selected_gender == 'male' ? 'selected' : '' ?>><?php echo "Male" ?></option>
                                        <option value="female" <?php echo isset($selected_gender) && $selected_gender == 'female' ? 'selected' : '' ?>><?php echo "Female" ?></option>
                                        <option value="other" <?php echo isset($selected_gender) && $selected_gender == 'other' ? 'selected' : '' ?>><?php echo "Other" ?></option>
                            ...
                            <table class="custom-table table table-striped table-bordered table-hover example">
                                <thead>
                                    <tr><?php $total_sum = 0; ?>
                                        ...
                                        <th>Male</th>
                                        <th>Female</th>
                                        <th>Other <small>(Gender)</small></th> 
                                        <th>IPD</th> 
                                        <th>OPD</th> 
                                        <th>Total</th>
                                    </tr>
                                    ...
                                    if (empty($resultlist)) {
                                        ...
                                        foreach ($resultlist as $patient) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo $patient['national']; ?></td>
                                                <td><?php echo $patient['other_national']; ?></td>
                                                <td><?php echo $patient['Male']; ?></td>
                                                <td><?php echo $patient['Female']; ?></td>
                                                <td><?php echo $patient['Other']; ?></td>
                                                <td><?php echo $patient['IPD']; ?></td>
                                                <td><?php echo $patient['OPD']; ?></td>
                                                <?php $total_sum += ($patient['national'] + $patient['other_national']); ?><td><?php echo number_format(($patient['national']+$patient['other_national']), 2); ?></td> 
                                            </tr>
                                    <?php
                                            $count++;
                                        }
                                ...
                                <tbody>
                                    <tr class="box box-solid total-bg">
                                        <td colspan="12" class="text-right">Total: <?php echo number_format(($total_sum), 2); ?></td>
                                    </tr>
                                </tbody>
                            </table>
