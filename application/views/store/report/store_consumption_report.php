            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">Department-Wise Drug Transfer Report – Detailed Summary of Drugs Issued to Each Department</h3>
                    
                    </div>
                    <form role="form" action="<?php echo site_url('hospital/report/storeconsumptionreport') ?>" method="post" class="" onsubmit="return validateForm(event)">
