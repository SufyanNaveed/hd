...
<div class="content-wrapper">
    ...
    <script type="text/javascript">
        ...
        function getmedicine_name(id, rowid) {
            var div_data = "";
            var store_id = $('#supplier_list').val();
        ...
        var batch_no = $("#batch_no" + rowid).val();

            //$("#medicine_name" + rowid).prepend($('<option></option>').html('Loading...'));
            $.ajax({
                url: '<?php echo base_url(); ?>hospital/pharmacy/getExpiryDate',
                type: "POST",
                data: {'batch_no': batch_no ,'med_id': medicine_id},
                ...
                success: function(res) {
                    ...
                    if (res.quantity) {
                        ...
                        $("#totalqty" + rowid).html(res.quantity);
                    }
    ...
    $.ajax({
        url: '<?php echo base_url(); ?>hospital/pharmacy/addSupplierReturnStock',
        type: "POST",
        ...
        success: function(data) {
            ...
            if (data.status === "fail") {
                ...
                successMsg(data.message);
                window.location.href = "<?php echo base_url(); ?>hospital/refundPharmacy/returnSupplierStock";
            }
        },
