            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix">Return Supplier Stock</h3>
                        <div class="box-tools pull-right">
                              <div class="box-tools pull-right">
                                <a data-toggle="modal" href="<?php echo base_url(); ?>hospital/refundPharmacy/addSupplierReturnStock" class="btn btn-primary btn-sm addpurchase"><i class="fa fa-plus"></i>Add Return Stock</a> 

                        </div>
                                <!-- <a data-toggle="modal" href="<?php echo base_url(); ?>hospital/refundPharmacy/addReturnStock" class="btn btn-primary btn-sm addpurchase"><i class="fa fa-plus"></i>Add Return Stock</a>  -->
                        ...
                        <table class="custom-table table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($resultlist as $pharmacy) {
                                    ?>
                                    <tr class="">
                                        <td><?php echo $pharmacy['date']; ?></td>
                                        <td><?php echo $pharmacy['store_name']; ?></td>
                                        <td><?php echo $pharmacy['supplier_category']; ?></td>
                                        <td >
                                                <a href="#" onclick="viewDetail('<?php echo $pharmacy['id'] ?>')"
                                                   data-toggle="tooltip"  title="<?php echo $this->lang->line('show'); ?>" ><?php echo $pharmacy['id']; ?></a> 
                                        </td>

                                        <td class="text-right">

                                            <a href="#" 
                                            onclick="viewDetail(<?php echo $pharmacy['id']; ?>, '<?php echo $pharmacy['bill_status']; ?>')"
                           ...
                           <input name="invoiceno"  id="invoiceno" type="hidden" class="form-control"/>
                                ...
                                <div class="col-md-12" style="clear: both;">
                                    <div class="table-responsive">
                                        <table class="custom-table table tableover table-striped table-bordered table-hover mb10 tablefull12" id="tableID">
                                            <tr>
...
<script>
            ...
            function edit_bill(id,status) {
                if(status == 'draft'){

                    // Construct the URL for the edit page
                    var editUrl = '<?php echo base_url(); ?>hospital/store/editSupplierBillPage/' + id;
        ...
        //     $.ajax({
        //     url: '<?php echo base_url(); ?>hospital/pharmacy/getindate',
        //     type: "POST",
        //     data: {purchase_id: id},
        //     dataType: 'json',
        ...
        //        $.ajax({
        //             url: '<?php echo base_url(); ?>hospital/pharmacy/editSupplierBill/' + id,
        //             success: function (res) {
        ...
        // } 
            ...
            function viewDetail(id, status) {
                ...
                $.ajax({
                    url: '<?php echo base_url() ?>hospital/pharmacy/getReturnOpeningStockDetail/' + id,
                    type: "GET",
                    data: {id: id},
                    success: function (data) {
...
$('#edit_deletebill').html(
    "<a href='#' onclick='edit_bill(" + id + ", \"" + status + "\")' data-toggle='tooltip' data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a>"
);
