...
<div class="content-wrapper">
    ...
    function submitBillForm(button) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>hospital/store/saveRequest',
            type: "POST",
