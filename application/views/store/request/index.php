    ...
    <section class="content">
        <div class="row">
            ...
            <?php foreach ($requests as $request): ?>
                <tr>
                    <td><?php echo $request->purchase_no; ?></td>
                    <td><?php echo date('Y-m-d', strtotime($request->date)); ?></td>
                    <td><?php echo htmlspecialchars($request->store_name); ?></td>
                    <td >
                    <?php echo $request->status === 'requested' ? 'pending' : $request->status; ?>
                    </td>
                    <td>
                        <?php if($request->bill_status == 'draft'){?>
                            <a href="<?php echo base_url('hospital/store/editMedicineRequest?id=' . $request->id); ?>" 
   class="btn btn-info btn-sm">
   Edit
</a>
                           <?php }?>
                    <a href="<?php echo base_url('hospital/store/viewRequest?id=' . $request->id); ?>" 
   class="btn btn-info btn-sm">
   View
</a>
