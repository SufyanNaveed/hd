        ...
        <div class="row">
            <div class="col-md-2">
                <div class="box border0">
                    <ul class="tablists">
                        <!-- <li><a href="<?php echo base_url(); ?>hospital/itemcategory" ><?php echo $this->lang->line('item_category'); ?></a></li> -->
                        <li><a href="<?php echo base_url(); ?>hospital/itemsupplier" class="active"><?php echo $this->lang->line('item_supplier'); ?></a></li>
                    </ul>
                </div>
            </div>
                                        ...
                                        foreach ($itemsupplierlist as $supplier) {
                                            ...
                                            <tr>   
                                                ...
                                                <td class="mailbox-date pull-right no-print">
                                                        ...
                                                        <a  class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_recordById('<?php echo base_url(); ?>hospital/itemsupplier/delete/<?php echo $supplier['id'] ?>', '<?php echo $this->lang->line('delete_message') ?>')">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="formadd" action="<?php echo site_url('hospital/itemsupplier/add') ?>" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
...
<div class="modal fade" id="editmyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="editformadd" action="<?php echo site_url('hospital/itemsupplier/edit') ?>" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="row">
                            <div class="col-md-6">
...
function delete_recordById(url, Msg) {
    ...
    function get(id) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url(); ?>hospital/itemsupplier/get_data/' + id,
