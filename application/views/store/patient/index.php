            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix">Medicine Assigned List</h3>
                        ...
                        <div class="box-tools pull-right">
                            <!-- <a data-toggle="modal" href="<?php echo base_url(); ?>hospital/store/createRequest" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Create Request 
                        </a> -->
                            ...
                            <a data-toggle="modal" href="<?php echo base_url(); ?>hospital/patient/assignMedicine" class="btn btn-primary btn-sm addmedicine"><i class="fa fa-plus"></i> Issue Medicine</a> 
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive-mobile">
                            <table class="custom-table table table table table-striped table-bordered table-hover test_ajax " cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php if (!empty($bills)): ?>
                                        <?php foreach ($bills as $request): ?>
                                            <tr>
                                                <td><?php echo $request->bill_no; ?></td>
                                                <td><?php echo date('Y-m-d', strtotime($request->date)); ?></td>
                                                <td><?php echo htmlspecialchars($request->patient_name); ?></td>
                                              
                                                <td>
                                                   
                                                    <a class="btn btn-warning btn-sm" href="<?php echo base_url('hospital/patient/viewMedicineDetail?id=' . $request->id); ?>" >View</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else: ?>
                        ...
                        <form id="view" accept-charset="utf-8" method="get" class="ptt10">
                            ...
                            <div class="col-lg-11 col-md-10 col-sm-8">
                                <div class="table-responsive">
                                    <table class="custom-table table table table mb0 table-striped table-bordered examples">
                                        <tr>
                                            <th></th>
                                            <td></td>
...
<script type="text/javascript">
    ...
    //     "serverSide": true,
    //     "ajax": {
    //         "url": base_url+"hospital/store/request_list?type=pending",
    //         "type": "POST",
