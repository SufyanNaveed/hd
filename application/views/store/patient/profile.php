                            ...
                            <div class="table-responsive">
                                <table class="custom-table table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                    <thead>
                                        ...
                                        <th><?php echo "OPD Slip No"; ?></th>
                                        <th>Hospital</th>
                                        <th>Department</th>
                                        <th>Store</th>


                                        <!-- <th><?php //echo $this->lang->line('refference'); 
                                                    ?></th>
                                        <th><?php //echo $this->lang->line('symptoms'); 
                                            ?></th> -->
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td><?php echo date('Y-m-d H:i:s', strtotime($value['appointment_date'])) ?></td>
                                                    <td><?php echo $value['opd_no']; ?></td>
                                                    <td><?php echo $value['opd_slip_no']; ?></td>
                                                    ...
                                                    <!-- <td><?php //echo $value['refference']; 
                                                                ?></td>
                                                        <td><?php //echo nl2br($value['symptoms']); 
                                                            ?></td> -->
                                                    </td>
                                                    ...
                                                    <td class="text-right" width="70">
                                                        ...
                                                        ?>
                                                            <a href="<?php echo base_url('hospital/patient/assignMedicine') . '?patient_id=' . $value['patient_id'] . '&visit_id=' . $value['id']; ?>"
                                                                class="btn btn-default btn-xs prescription" data-toggle="tooltip" title="<?php echo $this->lang->line('add_prescription'); ?>"><i class="fas fa-prescription"></i></a>
                                                        <?php
                                                        }
                                                        ?>
                                                        <?php  ?>
                                                        ...
                                                        ?>
                                                            <a class="btn btn-default btn-xs" href="<?php echo base_url('hospital/patient/viewMedicineDetail') . '?opd_id=' . $value['id']; ?>"
                                                                data-toggle="tooltip" title="<?php echo $this->lang->line('view') . " " . $this->lang->line('prescription'); ?>">
                                                                <i class="fas fa-file-prescription"></i>
                                                            </a>
                                                        <?php } ?>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?php
                                                        echo date('Y-m-d', strtotime($diagnosis_value['report_date']));
                                                        ?></td>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <form id="" class="pt5 pb5" accept-charset="utf-8" enctype="multipart/form-data" method="post">
                            <div class="table-responsive">
                                <table class="custom-table table mb0 table-striped table-bordered examples tablelr0space noborder">
                                    <tr>
                            ...
                            <div class="row row-eq">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="row ptt10">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label><?php echo "MR#"; ?></label>
                                                <input id="mr_no" name="mr_no" placeholder="" type="text" class="form-control" value="<?php echo set_value('name'); ?>" />
                                                <span class="text-danger"><?php echo form_error('name'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="patient_cnic" name="patient_cnic" data-inputmask="'mask': '99999-9999999-9'" pattern="\d{5}-\d{7}-\d" placeholder="XXXXX-XXXXXXX-X" class="form-control config" autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6" id="calculate">
                                                    <div class="form-group">
                                                        <label><?php echo 'Age (YY-mm--dd)' ?></label>
                                                        <div style="clear: both;overflow: hidden;">
                                                            <input type="text" placeholder="<?php echo $this->lang->line('year') ?>" name="age" id="eage_year" value="" class="form-control ager" style="width: 30%; float: left;">
                                                            <input type="text" id="eage_month" placeholder="<?php echo $this->lang->line('month') ?>" name="month" value="" class="form-control month" style="width: 30%;float: left; margin-left: 4px;">
                                                            <input type="text" id="eage_day" placeholder="<?php echo $this->lang->line('day') ?>" name="day" value="" class="form-control day" style="width: 27%;float: left; margin-left: 4px;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <input type="checkbox" name="paed" class="form-check-input" id="paed" autocomplete="off">
                                                <label class="form-check-label" for="paed">Paeds</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <input id="emobileno" autocomplete="off" name="contact" data-inputmask="'mask': '9999-9999999'" pattern="\d{4}-\d{7}" placeholder="XXXX-XXXXXXX" type="text" placeholder="" class="form-control config" value="<?php echo set_value('mobileno'); ?>" />
                                            </div>
                                        </div>
                        ...
                        <div class="col-sm-3">
                            <div class="col-sm-12">
                                <div class="form-group mt-2">
                                    <label>
                                        <?php echo "Problems"; ?><a data-toggle="modal" onclick="holdModal('add_symtoms')" class="btn btn-primary btn-sm adddiagnosis"><i class="fa fa-plus"></i></a></label>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>
                                        ...
                                        <a data-toggle="modal" onclick="holdModal('add_diagnosis','append_prescription_diagnosis')" class="btn btn-primary btn-sm adddiagnosis"><i class="fa fa-plus"></i></a></label>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>
                                        <?php echo $this->lang->line('precaution'); ?>
                                        <a data-toggle="modal" onclick="holdModal('add_precaution_manual','append_prescription_precaution')" class="btn btn-primary btn-sm "><i class="fa fa-plus"></i></a>
                                    </label>
                                    </label>
                                    <select class="form-control select2" style="width: 100%" id="precaution" name='precaution[]' multiple>
                                        <option value=""><?php echo $this->lang->line('select') ?>
                                        </option>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>
                                        <?php echo $this->lang->line('test') . ' ' . 'manual'; ?>
                                        <a data-toggle="modal" onclick="holdModal('add_test_manual','append_prescription_test_manual')" class="btn btn-primary btn-sm "><i class="fa fa-plus"></i></a>
                                    </label>
                                    <select class="form-control select2" style="width: 100%" name='test_manual[]' id="test_manual" multiple>
                                        <option value=""><?php echo $this->lang->line('select') ?>
                                        </option>
                                        <?php foreach ($test_manuals as $tr => $test_manual) {
                                        ?>
                                            <option value="<?php echo $test_manual["id"]; ?>"><?php echo $test_manual["test"] ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                                </div>
                        ...
                        <div class="col-sm-9">
                            <div class="ptt10">
                                <div class="row">
                                    <!-- <div class="col-sm-12">
                                    <div class="form-group">
                                        <label><?php //echo $this->lang->line('header_note'); 
                                                ?></label>
                                    ...
                                    <table class="custom-tablenobordertable" id="tableID">
                                        <tr id="row0">
                                            <td>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
...
<!-------add precaution -------------->
<div class="modal fade in" id="add_precaution_manual" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">×</button>
                <h4 class="box-title"> Add Precaution</h4>
            </div>
            <form id="precautionadd" name="employeeform" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Precaution </label><small class="req"> *</small>
                            <input autofocus="" id="precaution_ajax" name="precaution_ajax" placeholder="" type="text" class="form-control" value="" autocomplete="off">
                            <span class="text-danger"></span>
                        </div>
                    </div>
                </div><!--./mpdal-->
                <div class="box-footer">
                    <div class="pull-right" style="margin-right: 10px; ">
                        <button type="submit" data-loading-text="<?php echo $this->lang->line('processing') ?>" value="save_only_precaution" class="btn btn-info pull-right add_symptoms"><?php echo $this->lang->line('save'); ?></button>
                    </div>
                    <div class="pull-right" style="margin-right: 10px; ">
                        <button type="submit" data-loading-text="Processing..." class="btn btn-info  add_pre_manual pull-right" value="save_another">Save Another</button>
                    </div>
                </div>
            </form>
        </div><!--./row-->
...
<div class="modal fade in" id="add_test_manual" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="false">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">×</button>
                <h4 class="box-title"> Add Test</h4>
            </div>
            <form id="testmanualadd" name="employeeform" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                <div class="modal-body pt0 pb0">
                    <div class="ptt10">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Test </label><small class="req"> *</small>
                            <input autofocus="" id="test" name="test" placeholder="" type="text" class="form-control" value="" autocomplete="off">
                            <span class="text-danger"></span>
                        </div>
                    </div>
                </div><!--./mpdal-->
                <div class="box-footer">
                    <div class="pull-right" style="margin-right: 10px; ">
                        <button type="submit" data-loading-text="<?php echo $this->lang->line('processing') ?>" value="save_only_test" class="btn btn-info pull-right add_symptoms"><?php echo $this->lang->line('save'); ?></button>
                    </div>
                    <div class="pull-right" style="margin-right: 10px; ">
                        <button type="submit" data-loading-text="Processing..." class="btn btn-info  add_tst_manual pull-right" value="save_another">Save Another</button>
                    </div>
                </div>
            </form>
        </div><!--./row-->
...
<script type="text/javascript">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.opd_discount > 0) {
                    ...
                    $("#amount").html(parseInt(data.amount) - parseInt(data.opd_discount));
                } else {
                    $("#amount").html(parseInt(data.amount));
                }
    ...
    function getEditRecord(id) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#patient_cnic").val(data.patient_cnic);
    ...
    function viewmanual_prescription(id, opdid) {
        $.ajax({
            url: '<?php echo base_url(); ?>hospital/patient/getPrescriptionmanual/' + id + '/' + opdid,
            type: 'POST',
            data: {
                payslipid: id,
                print: 'yes'
...
<script type="text/javascript">
    ...
    function holdModal(modalId, append_value = "") {
        ...
        if (modalId == 'add_diagnosis' && append_value != '') {
            $('#append_prescription_diagnosis').val(append_value);
        }
        if (modalId == 'add_investigation' && append_value != '') {
            $('#append_prescription_lab').val(append_value);
        }
    }
    ...
    function deleteOpdPatientDiagnosis(patient_id, id) {
        if (confirm(<?php echo "'" . $this->lang->line('delete_conform') . "'"; ?>)) {
            $.ajax({
                url: '<?php echo base_url(); ?>hospital/patient/deleteOpdPatientDiagnosis/' + patient_id + '/' + id,
                success: function(res) {
                    successMsg(<?php echo "'" . $this->lang->line('delete_message') . "'"; ?>);
                    window.location.reload(true);
                }
...
<script>
    ...
    $(document).ready(function(e) {
        $("#precautionadd").on('submit', (function(e) {
            // Print the value of the button that was clicked
            var check_btn = ($(document.activeElement).val());
            e.preventDefault();
            $.ajax({
                url: '<?php echo base_url(); ?>admin/medicinedosage/addprecautionajax',
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
                ...
                success: function(data) {
                    if (data.status == "fail") {
                        ...
                        successMsg(data.message);
                        if (data.append_prescription_precaution != '') {
                            var div_data_lab = '';
                            ne = 'selected';
                            div_data_lab += "<option value='" + data.append_prescription_precaution + "' " + ne + " >" + data.append_prescription_precaution_name + "</option>";

                            $('#precaution').append(div_data_lab).trigger('change');
                        } else {
                            window.location.reload(true);
                        }
                        if (check_btn == 'save_only_precaution') {
                            $(".add_pre_manual").button('reset');
                            if (data.append_prescription_precaution != '') {
                                $("#precaution_ajax").val("");
                                $('#add_precaution_manual').modal('hide');
                            }
    ...
    $(document).ready(function(e) {
        $("#testmanualadd").on('submit', (function(e) {
            // Print the value of the button that was clicked
            var check_btn = ($(document.activeElement).val());
            e.preventDefault();
            $.ajax({
                url: '<?php echo base_url(); ?>admin/medicinedosage/addTest',
                type: "POST",
                data: new FormData(this),
                dataType: 'json',
                contentType: false,
                ...
                success: function(data) {
                    if (data.status == "fail") {
                        ...
                        successMsg(data.message);
                        if (data.append_prescription_test != '') {
                            var div_data_lab = '';
                            ne = 'selected';
                            div_data_lab += "<option value='" + data.append_prescription_test + "' " + ne + " >" + data.append_prescription_test_name + "</option>";

                            $('#test_manual').append(div_data_lab).trigger('change');
                        } else {
                            window.location.reload(true);
                        }
                        if (check_btn == 'save_only_test') {
                            $(".add_tst_manual").button('reset');
                            if (data.append_prescription_test != '') {
                                $("#test").val("");
                                $('#add_test_manual').modal('hide');
                            }
...
<script type="text/javascript">
    ...
    function refundRecord(id, status) {
        // alert(status);
        var url = '<?php echo base_url() ?>admin/patient/RefundTestReport/' + id + '/' + status;
