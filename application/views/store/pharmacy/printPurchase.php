            ...
            <div class="col-md-12">
                <div class="">
                    ...
                    <table width="100%" class="printablea4">
                        <tr>
                            <td align="text-left"><h5><?php echo $this->lang->line('purchase') . " " . $this->lang->line('no') . "#"; ?><?php echo $result["id"] ?></h5>
                            </td>
                            <td align="text-left"><h5><?php echo $this->lang->line('invoice_no') ."#"; ?><?php echo $result["invoice_no"] ?></h5>
                            </td>
                            <td align="right"><h5><?php echo $this->lang->line('date') . " : "; ?><?php echo $result['date'] ?></h5>
                            </td>
                            <td align="right"><h5>Status: <b><?php echo $result['bill_status'] ?></b></h5>
                            </td>
                        </tr>
                    </table>
                    <hr class="dividerhrmb10">
                    <div class="table-responsive">
                        <table class="custom-table tableprintablea4" cellspacing="0" cellpadding="0" width="100%">
                            <tr>
