            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <a data-toggle="modal" href="<?php echo base_url(); ?>hospital/pharmacy/stockTransfer" class="btn btn-primary btn-sm"><i class="fa fa-upload"></i>Indent / Transfer Medicine
                        </a>
