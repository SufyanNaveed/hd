            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix"> Stock Transfer</h3>
                        <div class="box-tools pull-right">
                            ...
                            <!-- <a  class="btn btn-primary btn-sm" href="<?php echo base_url() ?>hospital/pharmacy/stockTransferAdd"><i class="fa fa-plus"></i> Add Stores Stock</a> -->
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        <div class="download_label">Stock Transfer</div>
                        <table class="custom-table table table table table-bordered table-hover custom-table table-success test_ajax" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th><?php echo $this->lang->line('bill') . " " . $this->lang->line('no'); ?></th>
                                    <th>Date</th>
                                    <th>From <?php echo $this->lang->line('store')  ?></th>
                                    <th>Username</th>
                    ...
                    <div class="col-lg-6 col-sm-5">
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-sm-4 col-xs-9">
                                <input name="date" id="date_pharmacy" type="text" value="<?= date('d-m-Y H:i:s') ?>" class="form-control" />
                            </div>
                        </div><!--./row-->
                    </div><!--./col-sm-6-->
                                        ...
                                        <table class="custom-table table table table tableover table-striped table-bordered table-hover tablefull12" id="tableID">
                                            <thead>
                                                <tr class="font13">
                                                    ...
                                                    <th class="text-right" width="5%"><?php echo $this->lang->line('discount'); ?></th>
                                            ...
                                            <tr id="row0">
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <input type="text" name="discount_single[]" onkeyup="multiply(0)" id="discount_single0" placeholder="" class="form-control text-right">
                                            ...
                                            <table class="custom-table tableprintablea4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right ipdbilltable">
                                                        <h4 style="float: right;font-size: 12px; padding-left: 5px;"> %</h4><input type="text" placeholder="Discount" value="" name="discount_percent" id="discount_percent" style="width: 70%; float: right;font-size: 12px;" class="form-control" />
                                                    </td>
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-sm-3 col-xs-9">
                                <input name="edit_date" id="editdate" type="text" value="" class="form-control" />
                            </div>
                        </div><!--./row-->
                    </div><!--./col-sm-6-->
...
<script type="text/javascript">
    ...
    function edit_bill(id, purchase_no, supplier_id, invoiceno) {
        ...
        var editUrl = '<?php echo base_url(); ?>hospital/pharmacy/editTransferBillPage/' + id;
    ...
    function viewDetail(id, bill_status) {

        $.ajax({
            url: '<?php echo base_url() ?>hospital/pharmacy/getStockDetails/' + id,
            type: "GET",
            data: {
                id: id
            },
            success: function(data) {
                ...
                if (bill_status == 'draft') {
                    ...
                    $('#edit_deletebill').html(
                        "<a href='#' onclick='edit_bill(" + id + ")' data-toggle='tooltip' data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a>"
                    );
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.test_ajax').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": base_url + "hospital/pharmacy/report_bill_search",
                "type": "POST",
            },
            responsive: 'true',
            dom: "Bfrtip",
