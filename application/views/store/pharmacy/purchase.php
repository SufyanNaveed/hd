                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                                <a data-toggle="modal" href="<?php echo base_url(); ?>hospital/pharmacy/purchaseMedicine" class="btn btn-primary btn-sm addpurchase"><i class="fa fa-plus"></i> <?php echo $this->lang->line('purchase') . " " . $this->lang->line('medicine'); ?></a> 
                            ...
                            <tbody>
                                ...
                                foreach ($resultlist as $pharmacy) {
                                    ...
                                    <tr class="">
                                        ...
                                        <td >
                                                <a href="#" onclick="viewDetail('<?php echo $pharmacy['id'] ?>',null,null,null,'<?php echo $pharmacy['bill_status'] ?>')"
                                        ...
                                        <td><?php echo number_format($pharmacy['total'], 2); ?></td>

                                        <td class="text-right">

                                            <a href="#" 
                                               onclick="viewDetail(<?php echo $pharmacy['id'] ?>,<?php echo $pharmacy['purchase_no'] ?>,<?php echo $pharmacy['supplier_id'] ?>,'<?php echo $pharmacy['invoice_no'] ?>','<?php echo $pharmacy['bill_status'] ?>')"
...
<script>
    ...
    var editUrl = '<?php echo base_url(); ?>hospital/pharmacy/editSupplierBillPage/' + id;
    ...
    window.location.href = editUrl;
        ...
        // } 
            ...
            function viewDetail(id, purchase_no, supplier_id, invoiceno,bill_status) {

                $.ajax({
                    url: '<?php echo base_url() ?>hospital/pharmacy/getSupplierDetails/' + id,
                    type: "GET",
                    data: {id: id},
                    success: function (data) {
        ...
        "<a href='#' onclick='edit_bill(" + id + "," + purchase_no + "," + supplier_id + "," + '"' + invoiceno + '"' + ")' data-toggle='tooltip' data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a> " 
    );
                        }
