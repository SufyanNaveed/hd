                                    ...
                                    foreach ($supplierCategory as $supplier) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                    ...
                                                    <a  class="btn btn-default btn-xs"  data-toggle="tooltip" title="" onclick="delete_recordById('<?php echo base_url(); ?>hospital/medicinecategory/deletesupplier/<?php echo $supplier['id'] ?>', '<?php echo $this->lang->line('delete_message'); ?>')">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="formadd" action="<?php echo site_url('hospital/medicinecategory/addsupplier') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
...
<div class="modal fade" id="editmyModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-mid" role="document">
        <div class="modal-content modal-media-content">
            ...
            <form id="editformadd" action="<?php echo site_url('hospital/medicinecategory/addsupplier') ?>" name="employeeform" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                <div class="modal-body pt0 pb0">
...
function delete_recordById(url, Msg) {
    ...
    function get(id) {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url(); ?>hospital/medicinecategory/get_datasupplier/' + id,
            ...
            success: function (result) {
                ...
                $('#supplier_type_id').val(result.supplier_type_id);
