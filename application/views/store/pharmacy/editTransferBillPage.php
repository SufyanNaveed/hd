                                                ...
                                                <div class="col-sm-8 col-xs-6">
                                                    <select onchange="get_StoreDetails(this.value)" style="width: 100%" class="form-control select2" id="addpatient_id" name="store_id">
                                                        ...
                                                        <?php foreach ($hospitalStores as $dkey => $dvalue) {
                                                            $selected_id = isset($result['store_id']) ? $result['store_id'] : (isset($result['target_store_id']) ? $result['target_store_id'] : '');
                                                        ?>
                                                            <option value="<?php echo $dvalue["id"]; ?>"
                                                                <?php echo ($selected_id == $dvalue["id"]) ? "selected" : ""; ?>>
                                        ...
                                        <div class="col-lg-6 col-sm-5">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2 col-sm-3 col-xs-9">
                                                    <input readonly name="bill_no" id="billno" value="<?php echo $result['invoice_no'] ?>" type="text" class="form-control" />
                                                ...
                                                <div class="col-lg-5 col-sm-4 col-xs-9">
                                                    ...
                                                    <input name="purchase_no" type="hidden" value="<?php $result['purchase_no'] ?>" class="form-control" />
                                                </div>
                                            </div><!--./row-->
                                        </div><!--./col-sm-6-->
                                ...
                                <div class="modal-body pt0 pb0">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <input name="store_name" id="store_name" type="hidden" value="<?php echo $result['store_name']; ?>" class="form-control" />
                                            <?php
                                            $selected_store_id = isset($result['store_id']) ? $result['store_id'] : (isset($result['target_store_id']) ? $result['target_store_id'] : '');
                                            ?>
                                            <input name="store_id" id="store_id" type="hidden" value="<?php echo $selected_store_id; ?>" class="form-control" />
                                                                ...
                                                                <?php if (!empty($detail)) {
                                                                    foreach ($detail as $index => $item) { ?>
                                                                        ...
                                                                        <tr id="row<?php echo $index; ?>">
                                                                            ...
                                                                            <!-- Batch No -->
                                                                            <td width="16%">
                                                                                <input type="text" class="form-control" name="batch_no[]" id="batch_no<?php echo $index; ?>" value="<?php echo $item['batch_no']; ?>" readonly>
                                                                            </td>

                                                                            <!-- Expiry Date -->
                                                                            <td width="8%">
                                                                                <input type="text" readonly name="expire_date[]" id="expire_date<?php echo $index; ?>" class="form-control" value="<?php echo $item['expiry_date']; ?>">
                                                                            </td>

                                                                            <!-- Quantity -->
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text" name="quantity[]" id="quantity<?php echo $index; ?>" class="form-control text-right" value="<?php echo $item['quantity']; ?>">
                                                                            ...
                                                                            <!-- Purchase Price -->
                                                                            <td class="text-right">
                                                                                <input type="text" readonly name="purchase_price[]" id="sale_price<?php echo $index; ?>" class="form-control text-right" value="<?php echo $item['purchase_price']; ?>">
                                                                            </td>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(e) {
            ...
            $(".printsavebtn").on('click', (function(e) {
                ...
                e.preventDefault();
                $.ajax({
                    url: '<?php echo base_url(); ?>hospital/pharmacy/updateAddBill',
                    type: "POST",
                    data: postData,
                    dataType: 'json',
                    contentType: false,
