            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <table class="custom-table table table table table-bordered table-hover custom-table table-success test_ajax" cellspacing="0" width="100%"> <thead>
                                <tr>
                                    <th><?php echo $this->lang->line('bill') . " " . $this->lang->line('no'); ?></th>
                                    <th>Indent No</th>
                                    <th><?php echo $this->lang->line('date'); ?></th>
                                    <th><?php echo $this->lang->line('store') . " " . $this->lang->line('name'); ?></th>
                                    <th class="">Amount</th>
