	...
	renderHeadHtml: function() {
		...
		return '' +
			'<div class="fc-row ' + theme.getClass('headerRow') + '">' +
				'<table class="custom-table' + theme.getClass('tableGrid') + '">' +
					'<thead>' +
...
var ListViewGrid = Grid.extend({
	...
	renderSegList: function(allSegs) {
		...
		var daySegs;
		var i;
		var tableEl = $('<table class="custom-tablefc-list-table ' + this.view.calendar.theme.getClass('tableList') + '"><tbody/></table>');
